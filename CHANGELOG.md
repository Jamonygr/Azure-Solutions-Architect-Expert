...
## 2026-09-02 — Initial offline release

- Established the April 17, 2026 AZ-305 curriculum contract.
- Added 28 portable architecture labs and complete objective ownership.
- Added 1,250 assessment items for Labs 01–25.
- Added deterministic generation, schema validation, safety tests, documentation, and a container-local offline release gate.
- Kept live Azure, Microsoft Graph, Portal, screenshot, deployment, and Pages operations outside the release.
