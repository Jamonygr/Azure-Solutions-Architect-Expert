...
The read-only structural reference repository was clean before adaptation at Git HEAD `a532eb73711f7b8eb02ba95baa06a3a69376a1c3` and was rechecked clean at the same HEAD after adaptation. The target repository uses `main`, has no remote, and carries the annotated local release tag `az305-2026-04-offline`. No host component was upgraded; dependency acquisition and all verification occurred in the development container.
